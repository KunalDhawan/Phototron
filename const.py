...
#Gaussian blur , cv2.filter2D , ret, bot = cv2.threshold(bot,-1,255,cv2.THRESH_BINARY+cv2.THRESH_OTSU) , from geometry_msgs.msg import Point , rospy.init_node("main") , ref=time.time() , main1- lines 67-60 - why applied thrice , main1 - lines 88-90